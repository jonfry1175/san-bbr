...
const fwdImg = "https://placehold.co/800x600/f97316/ffffff?text=FWD";
...
const haulingRoadImg = "https://placehold.co/800x600/f97316/ffffff?text=Hauling+Road";
const earthworkLoopingImg = "https://placehold.co/800x600/f97316/ffffff?text=Earthwork+Looping";
const patokHaulingImg = "https://placehold.co/800x600/f97316/ffffff?text=Patok+Hauling";
const lpaDumpingImg = "https://placehold.co/800x600/f97316/ffffff?text=LPA+Dumping";
const konstruksiHaulingRadImg = "https://placehold.co/800x600/f97316/ffffff?text=Konstruksi+Hauling";
const earthworkLoopingCp2bImg = "https://placehold.co/800x600/f97316/ffffff?text=Earthwork+Looping+CP2B";
const preventifJalanKosonganImg = "https://placehold.co/800x600/f97316/ffffff?text=Preventif+Jalan";
const earthworkCheckoutBunatiImg = "https://placehold.co/800x600/f97316/ffffff?text=Earthwork+Checkout";
const maintenanceCsHaulingImg = "https://placehold.co/800x600/f97316/ffffff?text=Maintenance+Hauling";
const rambuReflektroizedImg = "https://placehold.co/800x600/f97316/ffffff?text=Rambu";
const restAreaImg = "https://placehold.co/800x600/f97316/ffffff?text=Rest+Area";
const solarStudLightImg = "https://placehold.co/800x600/f97316/ffffff?text=Solar+Stud";
const solarStudLightImg1 = "https://placehold.co/800x600/f97316/ffffff?text=Solar+Stud+1";
const solarStudLightImg2 = "https://placehold.co/800x600/f97316/ffffff?text=Solar+Stud+2";
const solarStudLightImg3 = "https://placehold.co/800x600/f97316/ffffff?text=Solar+Stud+3";
const solarStudLightImg4 = "https://placehold.co/800x600/f97316/ffffff?text=Solar+Stud+4";
const maintenanceChipsealImg = "https://placehold.co/800x600/f97316/ffffff?text=Maintenance+Chipseal";
const pelebaranKm14Img = "https://placehold.co/800x600/f97316/ffffff?text=Pelebaran+KM14";
const persiapanNorthStockpileImg = "https://placehold.co/800x600/f97316/ffffff?text=Persiapan+Stockpile";
const pelebaranKm12Img = "https://placehold.co/800x600/f97316/ffffff?text=Pelebaran+KM12";
const peningkatanAntrianTrukImg = "https://placehold.co/800x600/f97316/ffffff?text=Peningkatan+Antrian";
const upgradeHaulingRoadImg = "https://placehold.co/800x600/f97316/ffffff?text=Upgrade+Hauling";
const konstruksiLoopingCp9Img = "https://placehold.co/800x600/f97316/ffffff?text=Konstruksi+Looping";
const chipsealRestAreaImg = "https://placehold.co/800x600/f97316/ffffff?text=Chipseal+Rest+Area";
const additionalWorkKm12Img = "https://placehold.co/800x600/f97316/ffffff?text=Additional+Work";
const pavementAviaryImg = "https://placehold.co/800x600/f97316/ffffff?text=Pavement+Aviary";
const peningkatan10HaBunatiImg = "https://placehold.co/800x600/f97316/ffffff?text=Peningkatan+Bunati";
const maintenanceRoadBunatiImg = "https://placehold.co/800x600/f97316/ffffff?text=Maintenance+Road+Bunati";
const maintenanceJalanCp5Img = "https://placehold.co/800x600/f97316/ffffff?text=Maintenance+Jalan+CP5";
const northDrainageWorkImg = "https://placehold.co/800x600/f97316/ffffff?text=Drainage+Work";
const earthworkLoopingCp7Img = "https://placehold.co/800x600/f97316/ffffff?text=Earthwork+Looping+CP7";
const accessChargingStationTempImg = "https://placehold.co/800x600/f97316/ffffff?text=Access+Charging+Temp";
const aksesChargingStationImg = "https://placehold.co/800x600/f97316/ffffff?text=Access+Charging";
const jalanHaulingPitKgbKguImg = "https://placehold.co/800x600/f97316/ffffff?text=Hauling+Pit";
const chipsealRestAreaKm1Km4Img = "https://placehold.co/800x600/f97316/ffffff?text=Chipseal+Rest+Area+KM1";
const pavementPreservationJalurMuatanImg = "https://placehold.co/800x600/f97316/ffffff?text=Pavement+Preservation";
const doubleChipsealRestAreaImg = "https://placehold.co/800x600/f97316/ffffff?text=Double+Chipseal";
const doubleChipsealKosonganKm1Img = "https://placehold.co/800x600/f97316/ffffff?text=Double+Chipseal+KM1";
const peningkatanAreaKosonganImg = "https://placehold.co/800x600/f97316/ffffff?text=Peningkatan+Area";
const peningkatanAksesLoopingNorthStockpileImg = "https://placehold.co/800x600/f97316/ffffff?text=Peningkatan+Akses";
const chipsealRestAreaKm1Km42025Img = "https://placehold.co/800x600/f97316/ffffff?text=Chipseal+2025";
const aksesChargingStationBibImg = "https://placehold.co/800x600/f97316/ffffff?text=Access+Charging+BIB";
const stabilisasiParkirChargingStationBibImg = "https://placehold.co/800x600/f97316/ffffff?text=Stabilisasi+Parkir";
