...
const OurProductsSection = memo(() => {
  ...
  return (
    <MotionSection id="our-products" className="section-padding bg-background">
      <div className="container mx-auto container-padding">
        ...
        >
          ...
          <motion.p
            ...
            variants={item}
          >
            Jelajahi koleksi lengkap heavy equipment dan truck berkualitas
            tinggi untuk semua kebutuhan industri Anda
          </motion.p>
        </motion.div>
