...
const Career = memo(() => {
  ...
  const breadcrumbs = useMemo(
    () =>
      createBreadcrumbJsonLd([
        ...
        { name: t("common.career"), url: meta.path },
      ]),
    [t],
  );
  ...
  useEffect(() => {
    setHero({
      variant: "simple",
      label: translations.career.label,
      title: translations.career.pageTitle,
      description: translations.career.pageDescription,
    });
  }, [setHero, translations]);

  const employeeJobs: Job[] = useMemo(() => {
    const keys = [
      "project-engineer",
      "site-supervisor",
  ...
  return (
    <>
      <SEO
        title={translations.career.pageTitle || meta.title}
        description={translations.career.pageDescription || meta.description}
        ...
        jsonLd={[
          createWebPageJsonLd({
            name: translations.career.pageTitle || meta.title,
            description:
              translations.career.pageDescription || meta.description,
            url: meta.canonical,
            image: meta.image,
          }),
          breadcrumbs,
              ...
              <Card className="card-hover h-full flex flex-col">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <p
                    ...
                    // description may contain simple <em> markup from translations
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            <div className="md:col-span-2">
              ...
              <p className="text-body text-muted-foreground mt-2">
                ...
                <a
                  href={`mailto:${mailSecondaryRecruitment}`}
                  className="text-primary hover:underline"
                >
                  {mailSecondaryRecruitment}
                </a>
              </p>
            </div>
